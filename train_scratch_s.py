...
def train_reg(model, task, trait, timestamp, output_path):
    """Train model."""
...
if __name__ == '__main__':
    ...
    if args.trait == 'ALL':
        for t in traits:
            ...
            train_reg(model, args.task, t, timestamp, output_path)
    else:
        logger.info(
            f'{"=========="*8}\n'
            f'Configuration:'
        ...
        train_reg(model, args.task, args.trait, timestamp, output_path)
